...
export function Malphor() {
  ...
  const { currentWaypoint, offset, moveToWaypoint } = useWaypointMovement(safeZones, 200);
  ...
  return (
    <>
      <motion.div
        ...
        className="fixed bottom-6 right-6 z-40 w-[200px] h-[250px] cursor-pointer select-none group focus:outline-none"
      >
        {/* Speech bubble — rendered in DOM layer above 3D canvas */}
        <div className="absolute bottom-[140px] right-[160px] w-[250px] pointer-events-none z-50">
