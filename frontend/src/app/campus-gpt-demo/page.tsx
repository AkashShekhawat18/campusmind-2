...
export default function CampusGPTDemo() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // If the user is a guest (no token), the backend handles any limit tracking or authorization.
      ...
      const responseContent = data.reply || data.error || "Error connecting to AI backend.";
