    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-panel p-8 rounded-2xl relative glow-border">
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        <div>
          ...
          <input type="email" className="w-full bg-deep-space/50 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-electric-violet transition-colors" placeholder="faculty@campusmind.edu" />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1">Password</label>
          <input type="password" className="w-full bg-deep-space/50 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-electric-violet transition-colors" placeholder="••••••••" />
        </div>
        ...
        <button type="submit" className="w-full py-3 rounded-lg bg-electric-violet text-white font-semibold hover:bg-electric-violet/90 transition-colors mt-6 shadow-[0_0_15px_rgba(138,43,226,0.4)] cursor-pointer">
          Sign In
        </button>
      </form>
